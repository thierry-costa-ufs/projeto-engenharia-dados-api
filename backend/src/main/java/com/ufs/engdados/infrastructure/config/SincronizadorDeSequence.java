    ...
    public void run(String... args) {
        try {
            ...
            if (!sequences.isEmpty()) {
                ...
                String sql = "SELECT setval('" + nomeSequenceId + "', coalesce((SELECT MAX(id_turma) FROM universidade.turma), 1))";
            ...
            List<Map<String, Object>> semestresValidos = jdbcTemplate.queryForList("SELECT ano, semestre FROM universidade.semestre LIMIT 5");
